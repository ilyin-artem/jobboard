import { ButtonProps, ButtonLinkProps } from './Button.props';
...
const variantStyles = {
    ...
    outline: {
        ...
        blue: 'ring-blue-200 text-blue-700 hover:text-blue-900 hover:ring-blue-300 active:bg-blue-100 active:text-blue-600 focus-visible:outline-blue-900 focus-visible:ring-blue-300',
    },
};
...
export const Button = ({
    ...
    return (
        <button
            ...
            {...props}
        >
            {/* children можно не прокидывать по умолчанию, т.к. он прокинтся вместе с ...props */}
            {children}
        </button>
    );
};
